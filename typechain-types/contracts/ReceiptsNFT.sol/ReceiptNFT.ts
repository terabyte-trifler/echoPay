...
export interface ReceiptNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface ReceiptNFT extends BaseContract {
  connect(runner?: ContractRunner | null): ReceiptNFT;
  waitForDeployment(): Promise<this>;

  interface: ReceiptNFTInterface;
